...
import { __dirname, calculateSubtotal, calculateTax } from "../utils.js";
...
export const updateProductCartController = async (req, res) => {
  try {
    ...
    const updatedCart = await cartModel.findByIdAndUpdate(cartId, { products: updatedProducts }, { new: true }).lean().exec();

    // Calcular el subtotal, el impuesto y el total del carrito actualizado
